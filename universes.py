...
ax2.plot(x_power, power_vlo, 'm', linewidth=1.5, label='Zmniejsz moc znacznie')
ax2.plot(x_power, power_lo , 'r', linewidth=1.5, label='Zmniejsz moc lekko')
ax2.plot(x_power, power_op , 'y', linewidth=1.5, label='Pozostaw aktualna moc')
ax2.plot(x_power, power_hi , 'c', linewidth=1.5, label='Zwieksz moc lekko')
ax2.plot(x_power, power_vhi, 'g', linewidth=1.5, label='Zwieksz moc znacznie')
ax2.set_title('Moc')
ax2.legend()
